...
public class DnCurrencyConversionActivity extends AppCompatActivity {
...
//            payMap.put("items",itemList);
    ...
    private static final class PayCallback implements Callback {
        ...
        PayCallback(@NonNull DnCurrencyConversionActivity activity) {
...
//        paymentIntentClientSecret = paymentIntentClientSecret.trim();
        ...
        if (params != null) {
            ...
            //start payment
            stripe.confirmPayment(DnCurrencyConversionActivity.this, confirmParams);
        }
    ...
    private final class PaymentResultCallback
        ...
        @NonNull private final WeakReference<DnCurrencyConversionActivity> activityRef;
        PaymentResultCallback(@NonNull DnCurrencyConversionActivity activity) {
            activityRef = new WeakReference<>(activity);
        }
...
//        return super.onOptionsItemSelected(item);
        Intent intent = new Intent(getApplicationContext(), DnMainNavbarActivity.class);
