...
## Tracking on Jira  (max 24 marks) 
  ...
  - Is the git commit message clear? (max 2 marks)
    ...
    Your Mark: 1 (some messages are missing the ticket number)
...
## Sprint Demo (Max 14 marks) 
  ...
  - Working software (max 2 marks)
    ...
    - Donation History
    - Search for Homeless Youth
    - Donate to being seen
    - Donation Goal (Creating from youth perspective + Seeing all goals)
      - Donation goal not appearing on profile page but is saved on the database.
  ...
  - Presentation (max 2 marks)
    ...
    Feedback: 
    - Labels for fields
    - Picture on the Donation page? (Is it necessary)
    - Titles for the different screens to show what screen it is.
    - Donation History Scrolling Screen too small or scrolls only a small section. Prob want a bigger search area
    - Location of Links/Buttons/Icons 
    - Have a Search Results list for who you are searching for
    - Field Sizes are a bit too small for a mobile device
    - Tabs for the profile page (balance and donation)
    - Navigation flow is not very organized
