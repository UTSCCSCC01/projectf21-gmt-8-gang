...
## summary.md (Max 8 marks)
  - Project objectives have been specified clearly (max 2 marks)   
    ...
    Your mark: _1 should be mnore specified about the donation. Also questions like how to identify if this is a actual homeless youth should be considered in objective?
  ...
  - Key users have been identified clearly (max 2 marks) 
    ...
    Your mark: _1 I don't understand what is the point of putting Willow England has the habit of using debit/credit cards.
...
## competition.md (Max 2 marks)
  ...
  competition.md Total Mark: _2 / 2
...
## Product Backlog PB.md (Max 8 marks) 
  ...
  - All user stories identify goal/desire and all identify why/benefit (max 2 marks) 
    ...
    Your mark: _1 some stories seems like duplicates (first and second)
...
## Documentation: README.md (max 3 marks)
  ...
  - Installation for your Software/System
    ...
    Your mark: _0 no commands provided, how to install MongoDB?
...
## Definition of done: done.md (max 2 marks)
  ...
  done.md Total Mark: 1_ / 2 too generic 
